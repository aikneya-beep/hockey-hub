...
import app_v40
import personal_hockey_v41  # registers /my-hockey and its API
import app_v19 as feature
import app_v05 as core

core.app.version = "0.41.0"


_old_home = core.render_page


def render_page_v41() -> str:
    page = _old_home().replace("v0.40", "v0.41", 1)
...
core.render_page = render_page_v41


_old_team = feature.render_team_page


def render_team_page_v41(team_key: str) -> str:
    page = _old_team(team_key).replace("v0.40", "v0.41")
    if 'href="/my-hockey"' not in page:
        page = page.replace(
...
feature.render_team_page = render_team_page_v41
